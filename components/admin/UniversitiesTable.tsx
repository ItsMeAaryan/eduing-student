        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-white/5">
            {filtered.length === 0 ? (
              ...
              filtered.map((uni) => (
                <tr key={uni.uid} className="hover:bg-card/[0.02] transition-colors group">
                  <td className="p-4">
                    <div className="flex items-center">
                      <div className="w-10 h-10 rounded-xl bg-card/5 text-textSecondary flex items-center justify-center font-bold mr-3 border border-white/10">
