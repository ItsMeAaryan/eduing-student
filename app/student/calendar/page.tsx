    ...
    <div className="flex-1 w-full max-w-7xl mx-auto flex flex-col p-4 md:p-8">
      ...
      >
        <div className="flex flex-col gap-2">
          <h1 className="text-2xl font-display font-semibold text-white">Calendar</h1>
          <p className="text-[14px] text-white/50 max-w-xl">
            Manage your application deadlines, interview schedules, and important dates.
          </p>
        </div>
        ...
        <div className="w-full h-[400px] bg-[#111114] border border-white/[0.06] rounded-[24px] flex flex-col items-center justify-center p-8 relative overflow-hidden group">
          ...
          <div className="w-16 h-16 rounded-[16px] bg-[#1A1A24] border border-white/[0.08] flex items-center justify-center text-amber-400 mb-6 shadow-inner group-hover:scale-110 transition-transform duration-500">
          ...
          <p className="text-[14px] text-white/40 text-center max-w-md leading-relaxed">
            We are designing a beautiful calendar view to ensure you never miss a deadline. Your timeline will sync here shortly.
          </p>
        </div>
      </motion.div>
    </div>
